...
function Logger(factory, name, parent) {
	parent = parent || null;

	/**
	 * Factory object for logger instance.
	 * @type {Object}
	 */
...
Logger.prototype.getChild = function(suffix) {
	...
	var base = this._name === this._factory.ROOT ? '' : this._name + '.';
	return this._factory.getLogger(base + suffix);
};
