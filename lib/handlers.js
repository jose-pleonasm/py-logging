 ...
 * File handler.
 *
 * @constructor FileHandlerOld
 * @extends Handler
 * @param {string} filename
 * @param {string} [encoding]
 */
function FileHandlerOld(filename, encoding) {
	encoding = encoding || '';
...
util.inherits(FileHandlerOld, Handler);

/** @inheritdoc */
FileHandlerOld.prototype.emit = function(record) {
	try {
		var data = this.format(record) + '\n';
