...
//------------------------------------------------------------------------------
//   Function for minimal and universal (Node & Browser) configuration
//------------------------------------------------------------------------------

function universalConfig() {
	var handler = new handlers.ConsoleHandler('', false);
	var formatter = new Formatter('%(levelname):%(name):%(message)', '');
