...
var baseExports = {
	 ...
	 */
	debug: manager.root.debug.bind(manager.root),
	 ...
	 */
	info: manager.root.info.bind(manager.root),
	 ...
	 */
	warning: manager.root.warning.bind(manager.root),
	 ...
	 */
	error: manager.root.error.bind(manager.root),
	 ...
	 */
	critical: manager.root.critical.bind(manager.root),
	 ...
	 * @see {@link Logger#log}
	 */
	log: manager.root.log.bind(manager.root),
